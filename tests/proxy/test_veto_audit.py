"""Tests for enchanter.proxy._veto_audit — durable veto audit log.
...
from enchanter.proxy import _veto_audit, upstream
from enchanter.proxy.canonical import CanonicalRequest, Message, TextPart
from enchanter.proxy.pipeline import PipelineOptions, VetoResult, run, stream
...
async def test_record_never_raises_on_unwritable_dir(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("ENCHANTER_STATE_DIR", str(blocker / "sub"))
