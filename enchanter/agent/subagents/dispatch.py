"""enchanter.agent.subagents.dispatch — the ``subagent`` Tool.
...
3. **Turn cap.** The inner loop's :data:`enchanter.agent.loop.MAX_ITERATIONS`
...
from enchanter.proxy.canonical import TextPart
...
class SubagentTool:
    ...
    matching :class:`enchanter.agent.loop.AgentLoop`.
    """
