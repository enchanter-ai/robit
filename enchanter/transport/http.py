...
- **TLS pinning** via :class:`~enchanter.transport.tls_pin.TlsPinStore` when
...
class StreamableHttpTransport:
    ...
    ----------
    descriptor:
        A :class:`~enchanter.transport.descriptor.TransportDescriptor` with
    ...
    tls_pin_store:
        Optional :class:`~enchanter.transport.tls_pin.TlsPinStore` for
    ...
    def _get_ssl_context(self) -> ssl.SSLContext | None:
        ...
        :func:`~enchanter.transport.tls_pin.verify_tls_pin` after the
