"""enchanter.llm._codex_responses — Responses API helpers (Codex CLI wire format).

Shared between :class:`enchanter.llm.chatgpt_client.ChatGptClient` (which posts
directly to ``chatgpt.com/backend-api/codex/responses``) and
:class:`enchanter.proxy.adapters.codex.CodexAdapter` (which parses / renders
