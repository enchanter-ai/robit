"""enchanter.proxy.adapters — wire-format adapters per provider API.
...
:mod:`enchanter.proxy.canonical` dataclasses.  Adapters do not call any
upstream SDK — that is :mod:`enchanter.proxy.upstream`'s job.
