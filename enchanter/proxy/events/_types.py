"""enchanter.proxy.events._types — emitter contract types.
...
(:func:`enchanter.proxy.events.load_emitters`) and the built-in emitter
...
class EmitContext:
    ...
    correlation_id, session_id:
        ...
        from :func:`enchanter.core.create_request_context`.
    response:
    ...
    accumulated_text:
        ...
        :class:`~enchanter.proxy.streaming.SecretSanitizingStream`.
...
class EventEmitter(Protocol):
    ...
    Discovery contract: a module under ``enchanter.proxy.events`` is treated
    ...
    :class:`enchanter.proxy.events.builtin.BuiltinEmitter`).  The pipeline
