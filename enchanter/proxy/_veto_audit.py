...
Sibling module :mod:`enchanter.proxy.pipeline` calls :func:`record_veto`
...
* Mirrors the sink convention established by
  :mod:`enchanter.loader.runtimes._audit` (sidecar-rejections.jsonl).
...
* fsync is opt-in via ``ENCHANTER_AUDIT_FSYNC=1``.
"""
