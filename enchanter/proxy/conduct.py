"""enchanter.proxy.conduct — inject enchanter conduct into proxy requests.
...
:func:`enchanter.conduct.load_conduct` +
:func:`enchanter.composer.conduct.select_rules` +
:func:`enchanter.composer.conduct.compose_conduct_xml`.
...
def _rule_to_dict(rule: object) -> dict:
    """Adapt a :class:`enchanter.conduct.ConductRule` to the composer's dict shape."""
    return {
