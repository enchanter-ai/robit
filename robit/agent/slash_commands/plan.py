"""robit.agent.slash_commands.plan — /plan, /edit, /cancel, /execute.
...
class ExecutePlanCommand:
    ...
    routed through the existing approval flow in :mod:`robit.agent.loop`.

    Wave 15.4+ should replace this with a true step-by-step executor that
    yields :class:`robit.agent.loop.AgentEvent` instances directly.
    """
