"""robit.agent.mcp.config — load MCP server configuration.
...
class MCPServerConfig:
    ...
    :class:`robit.transport.descriptor.TransportDescriptor` so the
    :class:`~robit.agent.mcp.client.MCPClient` can build a descriptor
