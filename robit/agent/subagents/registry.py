"""robit.agent.subagents.registry — role definitions + name → role map.
...
:class:`robit.agent.tools.ToolRegistry`.

Roles are *data*, not code. The runtime behavior lives entirely in
:class:`robit.agent.subagents.dispatch.SubagentTool` — the role
