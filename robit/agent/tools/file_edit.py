"""robit.agent.tools.file_edit — surgical string replacement in a file.

Companion to :mod:`robit.agent.tools.file_write`. Where ``file_write``
...
* Paths resolve via :func:`robit.agent.tools._paths.safe_resolve`; edits
