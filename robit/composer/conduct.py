"""robit.composer.conduct — assemble per-request conduct XML fragments.

This module is deliberately decoupled from ``robit.conduct`` (the loader
...
from robit.composer.xml import indent_block, xml_escape
