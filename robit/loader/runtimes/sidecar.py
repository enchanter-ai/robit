...
- 8 MiB per-message body cap matches robit.transport.stdio.
...
from robit.core.events import EnchantedEvent, PluginAck
...
class SidecarAdapter:
    ...
    async def _record_rejection(self, raw_event: dict, reason: str) -> None:
        ...
        `robit.loader.runtimes.sidecar.record_rejection` to capture calls.
        """
